...
functional_keys = [
    ...
    Key(["Shift"], "XF86AudioLowerVolume", lazy.spawn("volume 1%-")),
    Key(["Shift"], "XF86AudioRaiseVolume", lazy.spawn("volume 1%+")),
    Key([], "XF86AudioMicMute", lazy.spawn("pactl set-source-mute 0 toggle")),
    Key(["Shift"], "XF86AudioMicMute", lazy.spawn("noise-supression")),
    Key([], "XF86MonBrightnessDown", lazy.spawn("brightness 5%-")),
    Key([], "XF86MonBrightnessUp", lazy.spawn("brightness 5%+")),
    ...
    Key(["Shift"], "XF86MonBrightnessDown", lazy.spawn("brightness 1%-")),
    Key(["Shift"], "XF86MonBrightnessUp", lazy.spawn("brightness 1%+")),
    ...
    Key(["Control"], "XF86AudioRaiseVolume", lazy.spawn("notification-play 5%+")),
    Key(["Control"], "XF86AudioLowerVolume", lazy.spawn("notification-play 5%-")),
    Key(
        ["Control", "Shift"],
        "XF86AudioRaiseVolume",
        lazy.spawn("notification-play 1%+"),
    ),
    Key(
        ["Control", "Shift"],
