return {
  {
    ...
    opts = {
      ...
      highlights = {
        ...
        ["BufferLineBackground"] = { bg = "$bg_d", fg = "$fg" },
        ["BufferLineBufferVisible"] = { bg = "$bg_d", fg = "$fg" },
        ["BufferLineBufferSelected"] = { bg = "$bg0", fg = "$fg", fmt = "bold" },
        ["BufferLineDuplicate"] = { bg = "$bg_d", fg = "$fg" },
        ["BufferLineDuplicateVisible"] = { bg = "$bg_d", fg = "$fg" },
        ["BufferLineDuplicateSelected"] = { bg = "$bg0", fg = "$fg", fmt = "bold" },
        ["BufferLineTab"] = { bg = "$bg_d", fg = "$fg" },
        ["BufferLineTabSelected"] = { bg = "$bg0", fg = "$fg", fmt = "bold" },
        ["BufferLineTabClose"] = { bg = "$bg_d", fg = "$fg" },
        ["BufferLineSeparator"] = { bg = "$bg_d", fg = "$bg_d" },
        ["BufferLineSeparatorVisible"] = { bg = "$bg_d", fg = "$bg_d" },
        ["BufferLineSeparatorSelected"] = { bg = "$bg0", fg = "$bg0" },
        ["BufferLineOffsetSeparator"] = { bg = "$bg0", fg = "$bg0" },
        ["BufferLineTruncMarker"] = { bg = "$bg_d", fg = "$fg" },
        ["BufferLineIndicatorSelected"] = { bg = "$bg0", fg = "$bg0" },
        ["BufferLineOffsetExplorer"] = { bg = "$bg0", fg = "$fg", fmt = "bold" },
      },
    },
  },
  {
