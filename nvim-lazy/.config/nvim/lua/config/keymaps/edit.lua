...
map("i", "<C-A-j>", "<Escape><cmd>set paste<CR>m`o<ESC>``<cmd>set nopaste<CR>i", { desc = "Add empty line above" })
map("i", "<C-A-k>", "<Escape><cmd>set paste<CR>m`O<ESC>``<cmd>set nopaste<CR>i", { desc = "Add empty line below" })
