...
function! airline#themes#onedark#refresh()
  ...
  let g:airline#themes#onedark#palette.accents = {
        \ 'red': [ '#FF005C', '', s:term_red, 0 ]
        \ }

  let s:N1 = [ '#282C34', '#41A7FC', s:term_black, s:term_green ]
  let s:N2 = [ '#ABB2BF', '#3E4452', s:term_white, s:term_grey ]
  let s:N3 = [ '#41A7FC', '#282C34', s:term_green, s:term_grey ]
  ...
  let s:R1 = [ '#282C34', '#FF005C', s:term_black, s:term_red ]
  let s:R2 = s:N2
  let s:R3 = [ '#FF005C', '#282C34', s:term_red, s:term_grey ]
  ...
  " Errors
  let s:ER = [ '#282C34', '#FF005C', s:term_black, s:term_red ]
