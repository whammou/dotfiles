...
let s:N1 = [ s:guibg , '#00FF00' , s:termbg , 45 ]
let s:N2 = [ '#00FFFF' , s:guibg2, 202 , s:termbg2 ]
let s:N3 = [ '#767676' , s:guibg, 243 , s:termbg]
let g:airline#themes#simple#palette.normal = airline#themes#generate_color_map(s:N2, s:N1, s:N3)
let g:airline#themes#simple#palette.normal_modified = {
      \ 'airline_c': [ '#FF005C' , s:guibg, 160     , s:termbg    , ''     ] ,
      \ }


let s:I1 = [ s:guibg, '#AE00FF' , s:termbg , 82 ]
let s:I2 = [ '#00FFFF' , s:guibg2, 202 , s:termbg2 ]
let s:I3 = [ '#767676' , s:guibg, 243 , s:termbg ]
let g:airline#themes#simple#palette.insert = airline#themes#generate_color_map(s:I2, s:I1, s:I3)
...
let s:V2 = [ '#00FFFF' , s:guibg2, 202 , s:termbg2 ]
let s:V3 = [ '#767676' , s:guibg, 243 , s:termbg ]
let g:airline#themes#simple#palette.visual = airline#themes#generate_color_map(s:V2, s:V1, s:V3)
